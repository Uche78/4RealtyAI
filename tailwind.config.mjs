  ...
  theme: {
    extend: {
      colors: {
        ...
        brand: {
          primary: '#E6DED9',     // Primary/background - warm neutral
          accent: '#5C6173',      // Brand accent/CTA - sophisticated blue-gray
          text: '#2C2926',        // Text/strong contrast - rich dark brown
          secondary: '#AEA7A2',   // Secondary/subtle elements - warm gray
        },
